        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SMSCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Title = table.Column<string>(type: "TEXT", maxLength: 100, rowVersion: true, nullable: true),
                    PhoneNumber = table.Column<int>(type: "INTEGER", maxLength: 100, rowVersion: true, nullable: true),
                    Password = table.Column<string>(type: "TEXT", maxLength: 100, rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PhoneNumber = table.Column<int>(type: "INTEGER", maxLength: 100, rowVersion: true, nullable: true),
                    Description = table.Column<string>(type: "TEXT", maxLength: 100, rowVersion: true, nullable: true),
                    Location = table.Column<string>(type: "TEXT", maxLength: 100, rowVersion: true, nullable: true),
                    Email = table.Column<string>(type: "TEXT", maxLength: 100, rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConcertsId = table.Column<long>(type: "INTEGER", nullable: false),
                    ReservationsId = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConcertReservation", x => new { x.ConcertsId, x.ReservationsId });
                    table.ForeignKey(
                        name: "FK_ConcertReservation_Concert_ConcertsId",
                        column: x => x.ConcertsId,
                        principalTable: "Concert",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConcertReservation_Reservation_ReservationsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Days = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    ConcertId = table.Column<long>(type: "INTEGER", nullable: true),
                    ReservationId = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConcertReservation_ReservationsId",
                table: "ConcertReservation",
